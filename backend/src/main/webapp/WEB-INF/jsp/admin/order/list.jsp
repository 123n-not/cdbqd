                                ...
                                <c:otherwise>
                                    <c:forEach items="${orders}" var="order">
                                        <tr>
                                            <td>${order.id}</td>
                                            <td>${order.userId}</td>
                                            <td>${order.powerBankSerialNumber != null ? order.powerBankSerialNumber : '-'}</td>
                                            <td>${order.stationName != null ? order.stationName : '-'}</td>
                                            <td><fmt:formatDate value="${order.rentTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                            <td>
