                                ...
                                <c:otherwise>
                                    <c:forEach items="${stations}" var="station">
                                        <tr>
                                            ...
                                            <td>${station.description != null ? station.description : '-'}</td>
                                            <td>${station.totalSlots}</td>
                                            <td>${station.availableSlots}</td>
                                            <td>
                                                <button class="btn btn-primary btn-action" onclick="editStation(${station.id})">编辑</button>
                                                <button class="btn btn-danger btn-action" onclick="deleteStation(${station.id})">删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:otherwise>
...
<script>
    ...
    function editStation(id) {
        window.location.href = '/admin/station/edit/' + id;
    }

    function deleteStation(id) {
        if (confirm('确定要删除该投放点吗？')) {
            axios.delete('/admin/station/delete/' + id)
                .then(response => {
